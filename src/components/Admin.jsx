  ...
  return (
    <main className="admin-page">
      ...
      <div className="admin-shell">
        <div className="admin-heading"><div><span className="eyebrow">Operations desk</span><h1>Session bookings</h1><p>Incoming customer requests and appointment details.</p></div><button className="admin-refresh" onClick={() => loadBookings()}>Refresh</button></div>
