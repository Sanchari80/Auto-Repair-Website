...
const SHOTS = [
  { tag: 'Bumper respray', tone: '#ff5a1f', image: 'https://images.unsplash.com/photo-1485965120184-e220f721d03e?auto=format&fit=crop&w=900&q=85' },
  { tag: 'Frame pull', tone: '#35c0d8', image: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=900&q=85' },
  { tag: 'Full repaint', tone: '#f5c518', image: 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=900&q=85' },
  { tag: 'Ceramic coat', tone: '#ff8a3d', image: 'https://images.unsplash.com/photo-1542362567-b07e54358753?auto=format&fit=crop&w=900&q=85' },
  { tag: 'Dent removal', tone: '#9aa0ab', image: 'https://images.unsplash.com/photo-1553440569-bcc63803a83d?auto=format&fit=crop&w=900&q=85' },
]
